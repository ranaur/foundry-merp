...
import {PACKAGE_TYPES, COMPENDIUM_ENTITY_TYPES} from "./constants.mjs";
...
class PackageCompendiumData extends DocumentData {
  static defineSchema() {
    return {
      ...
      entity: fields.field(fields.REQUIRED_STRING, {
        validate: v => COMPENDIUM_ENTITY_TYPES.includes(v),
