...
export class Merp1eStaticManeuverChatCard extends Merp1eBaseChatCard {
    ...
    getData() {
        ...
        data.modifiersByGroup.push(new Merp1eModifiers("smm", "Static Modifiers", game.merp1e.Merp1eRules.skill.modifiers.Static));
        ...
        data.resolveResult = game.merp1e.Merp1eRules.resolveStaticManeuverLabel(data.total);
        data.resolveText = game.merp1e.Merp1eRules.resolveStaticManeuverText(data.total, data.skill);
        return data;
    }
